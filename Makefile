...
#    Updated: 2018/10/08 17:48:05 by gpouyat          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME_NM = main.c handle_64.c handle_32.c find_seg_sect_name.c get_symtab_cmd.c handle_fat.c print.c print_nm.c flags.c handle_lib.c sort.c get_char_type.c

SRC_NAME_OTOOL = main.c flags.c go_text_32.c print_otool.c handle_32.c handle_64.c go_text_64.c handle_fat.c handle_lib.c
